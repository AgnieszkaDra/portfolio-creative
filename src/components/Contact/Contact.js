...
const showError = (field, message) => {
  ...
  const validateEmail = (form) => {
    if (emailRegEx.test(email) && form !== '' && message !== '') {
      removeError('email');
      // Assuming contactForm and emailjs are set up elsewhere
      // Replace this section with your emailjs logic
  ...
  return (
    ...
    >
      ...
      {/* <div class="form__popup">
        <p class="form__popup-text">Formularz został poprawnie wysłany!</p>
        <button class="form__popup-close">Zamknij</button>
      </div> */}
        <div className={"contact__background-first"}>
